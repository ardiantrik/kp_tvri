...
<table width="100%" align="center" style="background-color:black;"><tr><td align="right"><img src="http://tvrijogja.com/utama/images/logo.png" width="100"></td><tr></table>
	<center>
		<h3>LIST JOBDESC</h3>
	<form method="POST" action="<?php echo base_url()."index.php/MainController/inputSasaran/"; ?>">
		<input type="hidden" name="nama" value="test dicoba">
		<table width="80%" class="table">
			<tr>
				<td colspan="3" align="center">TUGAS UTAMA</td>
			</tr>
			<tr>
				<th>NO.</th>
				<th>JOBDESC</th>
			...
			for ($i=0; $i < $count_jobdesc_u; $i++) { ?>
				<tr>
					<td width="5%"><?= $i+1; ?></td>
					<td><input type="hidden" name="jobdesc_u[]" value="<?= $jobdesc_u[$i]; ?>"><?= $jobdesc_u[$i]; ?></td>
					<td align="center" width="20%"><input type="number" name="sasaran_u[]" value="0" align="center"></td>
				</tr>
			<?php
			}
			?>
		...
		<table width="80%" class="table">
			...
			if ($count_jobdesc_t > 0) {
				...
				<tr>
					<td colspan="3" align="center"><h4>Tidak Terdapat Tambahan</h4></td>
				</tr>
